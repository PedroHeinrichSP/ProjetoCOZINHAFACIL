...
class AppColors {
  static const Color primaryColor = Color(0xffede2e0); // Tomato Red
  static const Color secondaryColor = Color(0xFFFFD700); // Gold
  static const Color backgroundColor = Color(0xFFDFE9E4); // Light Gray
  ...
  static const Color successColor = Color(0xFF00A859); // Green
